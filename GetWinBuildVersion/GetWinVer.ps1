...
(
   ...
   # [string[]]$ComputerName = $env:COMPUTERNAME # Works for one
   
   [string[]]$ComputerName = @("NAORALBPD160001","NAORALBPD160003","NAORALBPD160004","NAORALBPD160005","NAORALBPN200008","NAORALBPN200007","NAORALBPN200006","NAORALBPN200005","NAORALBPN190005")

   # Nope: [string[]]$ComputerName = 'C:\tmp\Book1.csv'
)
