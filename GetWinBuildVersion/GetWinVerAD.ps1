...
# $Computers = Get-ADComputer -Filter * -properties Name, OperatingSystem, OperatingSystemVersion, LastLogonDate, whenCreated
 $Computers = Get-ADComputer -Filter 'name -like "naoralbp*"'-properties Name, OperatingSystem, OperatingSystemVersion, LastLogonDate, Description # whenCreated
## $Computers = Get-ADComputer -Filter 'name -like "nacahesp*"'-properties Name, OperatingSystem, OperatingSystemVersion, LastLogonDate, Description
