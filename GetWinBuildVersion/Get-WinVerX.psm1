...
#
            ...
            try {
                ...
                $ComputerNames = Get-ADComputer -Filter {(Enabled -eq $true)} -SearchBase $ouName | Select -Expand Name
#
                $ComputerNamesCnt = $ComputerNames.Length
#
                write-host "Found $ComputerNamesCnt devices to check."
            }
            catch {
...
#
    Process
    {
        ...
        Foreach ($Computer in $ComputerNames)
        {
            ...
            Else
            {
                Write-Host "Sending to Try/Code"
                Try
                {
                ...
                Catch
                {
                    Write-Host "Try/Code Caught:" -ForegroundColor Yellow
                    $_
                }
            }
